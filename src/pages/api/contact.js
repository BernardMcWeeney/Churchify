...
export async function POST({ request }) {
  try {
    ...
    if (!region || !accessKeyId || !secretAccessKey || !fromAddress || !toAddress) {
      ...
      return jsonResponse({ success: false, message: 'Server configuration error. Please email us directly at info@churchify.ie.' }, 500);
    }
...
<p><strong>Message:</strong> ${message}</p>`;
    ...
    if (!sesResponse.ok) {
      ...
      return jsonResponse({ success: false, message: 'Something went wrong sending your message. Please email us directly at info@churchify.ie.' }, 500);
    }
